...
class TemporaryFolder:
    ...
    def __init__(self, path: str, close_mode: DirectoryCloseMode = DirectoryCloseMode.DELETE_DIRECTORY):
        ...
        Arguments:
            ...
            to_delete (DirectoryClosemode): determines the action performed to the directory once the context manager is 
            closed
        '''
        self._path: str = path
    ...
    def __exit__(self, exc_type, exc_val, traceback) -> None:
        ...
        Argument:
            ...
            traceback: 
        """
        if self._close_mode in {DirectoryCloseMode.DELETE_CONTENTS, DirectoryCloseMode.DELETE_DIRECTORY}:
